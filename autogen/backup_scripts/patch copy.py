...
] # TODO: load irony database to obtain excludes
    ...
    for modid, job_defs in job_def_table.items():
        for seg in job_defs:
                                ...
                                case b'produces' | b'upkeep':
                                    ...
                                    if b'multiplier' in x[2]:
                                        ...
                                        if giga_modid in job_to_modid[jn] and val == b'10':
                                            ...
                                            print('unsupported multiplier detected', val, job_to_modid[jn])
                                            danger += 100
                        ...
                        for mod in split3(prop_value):
                            match mod[0]:
                                case b'mult' | b'multiplier':
                                    if mult:
                                        print('multiple mult detected!! using last one')
                                    match mod[2]:
                                        ...
                                        case y:
                                            mult = y
                                            print('mult detected in modifiers!!!!!! ', y)
                                case b'potential':
                                    if potential:
            ...
            deposit_params = [
                ...
                b'planet_modifier', b'=', [
                    b'PR_smod_plnt_JOB_deposit_%s' % (job_to_modabb[jn] if jn in job_to_modabb else b'MYCOMPAT'), b'=', b'1'
                ],
                b'triggered_planet_modifier', b'=', [
                    ...
                    b'PR_smod_plnt_CAT_%s_add' % jobcat, b'=', b'1',
                ]
            ] + deposit_params
