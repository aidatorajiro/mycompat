...
def is_eq_like(c):
    return c == b'=' or c == b'>=' or c == b'<=' or c == b'<' or c == b'>'
...
# PLEASE EDIT HERE ACCORDING TO THE CURRENT PLAYSET
mod_excludes += [
    '688086068', # star trek
    ...
    for modid, job_defs in job_def_table.items():
        for seg in job_defs:
            ...
            if get_field(spl, b'is_capped_by_modifier') == b'no':
                ...
                print('Committing a job that is not capped by modifier ... %s' % jn.decode())
                            ...
                            match mod[0]:
                                ...
                                case y:
                                    if prop_name.endswith(b'planet_modifier'):
                                        ...
                                        print('unsupported pop modifier detected!!!!!', prop_name, jn, y)
                                        danger += 100
                                    elif prop_name.endswith(b'country_modifier'):
                                        print('unsupported country modifier detected!!!!!', prop_name, jn, y)
                                        # TODO: implement country modifier hack
